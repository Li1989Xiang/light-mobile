...
public class TestC04FundDT extends TestBase{
	...
	public void testDT(Map<String, String> param){
		...
		//选择投资描述
		//mPageFundFixed.doChooseDescription(param.get("投资描述"));
		//选择期满条件
		//mPageFundFixed.doChooseCondition(param.get("期满条件"));
		//获取开始日期和结束日期
